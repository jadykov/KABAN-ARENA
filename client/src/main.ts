...
async function boot(): Promise<void> {
  ...
  const snapDebug = new SnapDebugOverlay(() => {
    ...
    return {
      ...
      stallMaxDiv: SELF_RECONCILE_UP_SNAP_MAX_DIV,
      ...
      stallFrames: telemetry.stallFrames,
      stallMinFrames: SELF_RECONCILE_STALL_MIN_FRAMES,
      framesOk: telemetry.stallFramesOk,
